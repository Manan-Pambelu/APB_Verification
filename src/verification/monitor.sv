class monitor;
	...
	task start();
		...
		begin
			...
			$display("MONITOR TO SCOREBOARD PADDR is %h | PSEL is %d | PENABLE is %d | PWRITE is %h | PWDATA is %h | PSTRB is %b ",trans_obj.PADDR,trans_obj.PSEL,trans_obj.PENABLE,trans_obj.PWRITE, trans_obj.PWDATA, trans_obj.PSTRB);
